...
@Disabled
@TeleOp(name="14273 LKTest2 TeleArcadeBlue", group="C14273")
public class T1_LKTest2_TeleopArcadeBlue extends LinearOpMode {
...
//    HeadingSolver headingSolver;    // LK New Test
    HeaderAimer headerAimer;  // LK New Test
    PositionTracker pt;
    Pinpoint odo;
    ...
    public void runOpMode() {
        ...
        DecodeSettings.lkTestMode2 = true;
...
//        headingSolver = new HeadingSolver(drive);
        headerAimer = new HeaderAimer(drive);
...
//            headingSolver.setNewTarget(DecodeSettings.targetBlue, true);
            headerAimer.setTarget(DecodeSettings.targetBlue);
        } else {
//            headingSolver.setNewTarget(DecodeSettings.targetRed, true);
            headerAimer.setTarget(DecodeSettings.targetRed);
        }
//        headingSolver.stopSolver();
        headerAimer.setAutoAim(false);
