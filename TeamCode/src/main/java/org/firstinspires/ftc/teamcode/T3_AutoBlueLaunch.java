...
//    }
    ...
    public void BaseAuto(TimedTask autoTasks) {
        Vector3 start = new Vector3(-51, -50, 140);
        Vector3 aprilTag = new Vector3(-50, -49, 122);

        Vector3 shoot = new Vector3(-16, -16, -139);
        LaunchData shootLaunchData = new LaunchData(3225, new Vector3(-11, -11, -139));

        Vector3 blueSpikeReady1 = new Vector3(-12,-28,-90);
        Vector3 blueSpike1 = new Vector3(-12,-48,-90);
        Vector3 blueSpikeReady2 = new Vector3(12,-28,-90);
        Vector3 blueSpike2 = new Vector3(12,-60,-90);
        Vector3 blueSpikeReady3 = new Vector3(34.5,-28,-90);
        Vector3 blueSpike3 = new Vector3(34,-60,-90);
