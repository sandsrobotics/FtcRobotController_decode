...
public class T1_AutoGoalBlue  extends T1_AutoGoalRed {
    ...
    Integer launchRPM = 2350; // TODO: Needs Tuning.
    ...
    Vector3 p_launchPosZero             = new Vector3(-28.0,-16,-141);    // GoalBlue Launching Position.
    Vector3 p_launchPosOne              = new Vector3(-28.0,-16,-141);    // GoalBlue Launching Position.
    Vector3 p_launchPosTwo              = new Vector3(-28.0,-16,-141);    // GoalBlue Launching Position for pinkServo. Z:???.
