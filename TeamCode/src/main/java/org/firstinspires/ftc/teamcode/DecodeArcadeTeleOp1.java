...
@TeleOp(name="14273 Arcade", group="B14273")
public class DecodeArcadeTeleOp1 extends LinearOpMode {
...
//        positionSolver.setSettings(PositionSolverSettings.specimenAssistSettings);
        ...
        if (!DecodeSettings.isDemoMode) new org.firstinspires.ftc.teamcode.parts.decode.IntakeTeleop(intake);
        robot.init();
