...
//@Config
public class Intake1 extends ControllablePart<Robot, IntakeSettings3, IntakeHardware3, IntakeControl1> {
    private final EdgeConsumer homingBucketZero = new EdgeConsumer();
    protected Drive drive;
    public IntakeTasks1 tasks;
    protected PositionTracker pt;
    public boolean isTeleop;
    public int launchRPM;

    //***** Constructors *****
    public Intake1(Robot parent, String modeName) {
        super(parent, "Slider", () -> new IntakeControl1(0.5, false, 0, false));
...
//    }
    ...
    public void onInit() {
        ...
        initializeServos();
        tasks = new IntakeTasks1(this, parent);
    ...
    @Override
    public void onRun(IntakeControl1 control) {
